...
Modified by Pablo to run for MedAustron machine (MA).
Changes (indicated with #PABLO comment): 
    -added settings attribute: settings.machine (SPS or MA)
    -added if statement in track_lin function according to settings.machine
...
class Settings:
    ...
    def __init__(self, name, outputdir=None, studygroup='', disk=None):
        ...
        self.septadb = self.home+"/input/septa_DB_nominal.tfs" #MA
        self.septadbreplace = None
        self.crystaldb = self.home+"/input/crystal_DB_nominal.tfs" #MA
