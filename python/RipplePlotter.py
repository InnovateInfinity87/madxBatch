...
def losses():
    ...
    lossdir="../Data/ripple_t98.0_a115.0_p50k/losses/"
    #lossdir="../Data/ripple_t84.0_a107.0_p50k/losses/"
    print "number of batches: " +str(len(os.listdir(lossdir)))
    ...
    axarr[0,1].set_title('ripple_t98.0_a115.0_p50k')
    ...
    lossdir="../Data/ripple_t1574.0_a12.0_p10k/losses/"
    #lossdir="../Data/ripple_t84.0_a107.0_p50k/losses/"
    print "number of batches: " +str(len(os.listdir(lossdir)))
    ...
    axarr[0,3].set_title('ripple_t1574.0_a12.0_p10k')
    ...
    lossdir="../Data/ripple_t282.0_a125.0_p50k/losses/"
    #lossdir="../Data/ripple_t84.0_a107.0_p50k/losses/"
    print "number of batches: " +str(len(os.listdir(lossdir)))
    ...
    axarr[0,2].set_title('ripple_t282.0_a125.0_p50k')
