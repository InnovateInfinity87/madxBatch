# -*- coding: utf-8 -*-
"""
Created on Tue Aug 23 00:29:34 2016
...
def losses():
    ...
    lossdir="../Data/realripple_50k_pure/losses/"
    #lossdir="../Data/ripple_t84.0_a107.0_p50k/losses/"
    print "number of batches: " +str(len(os.listdir(lossdir)))
    ...
    axarr[0,1].set_title('realripple_50k_pure')
    ...
    lossdir="../Data/realripple_50k_comp50100150/losses/"
    #lossdir="../Data/ripple_t84.0_a107.0_p50k/losses/"
    print "number of batches: " +str(len(os.listdir(lossdir)))
    ...
    axarr[0,3].set_title('realripple_50k_comp50100150')
    ...
    lossdir="../Data/realripple_50k_comp50100150300/losses/"
    #lossdir="../Data/ripple_t84.0_a107.0_p50k/losses/"
    print "number of batches: " +str(len(os.listdir(lossdir)))
    ...
    axarr[0,2].set_title('realripple_50k_comp50100150300')
