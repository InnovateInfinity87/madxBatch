...
def hitSeptum(xlist,pxlist,sepcorstep):
    a=2.7e-5
...
def losses():
    ...
    sepcorstep=(67.9-63.8)/3130
    lossesx,lossespx,lostfirst = hitSeptum(x,px,sepcorstep)
    ...
    axarr[0,0].set_title('glitch_t500e500_a1000_p50k')
    ...
    lossdir="../Data/misalligned/losses/"
    print "number of batches: " +str(len(os.listdir(lossdir)))
    ...
    axarr[0,1].set_title('misalligned')
