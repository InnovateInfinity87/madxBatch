...
if __name__ == "__main__":
  ...
  #  datproc.beamstats(lossfolder, lossloc=lossloc)
    ...
    if not pycoll:
        ...
        datproc.losshistscatter(lossfolder, lossloc=lossloc, xlim=[0.03759, 0.13], ylim=[0,0.004], xbin=0.001, ybin=0.00005, log=True, save=plotfolder+"/tpst_losshist_h.png")
